		...
		try {
			...
			for (int i = 0; i < input.size(); i++) {
				...
				if ((Integer.parseInt(parte1[1])-Integer.parseInt(parte1[0]))-(Integer.parseInt(parte2[1])-Integer.parseInt(parte2[0]))>=0) {
					...
					if (Integer.parseInt(parte1[0])<=Integer.parseInt(parte2[0]) && Integer.parseInt(parte1[1])>=Integer.parseInt(parte2[1])) {
						//la parte 1 contiene a la 2
						solution++;
					}
				} else {
					//la segunda parte es mayor
					if (Integer.parseInt(parte2[0])<=Integer.parseInt(parte1[0]) && Integer.parseInt(parte2[1])>=Integer.parseInt(parte1[1])) {
